    ...
    return (
      <div className="About">
        ...
        <div className="About--copy">
          <p>
          Hello! My name is Aaron Mitchell and I’m a <span className="highlight">Product Designer</span> at <a href="https://www.rover.com/" target="_blank">Rover.com</a>, an online pet care marketplace based in Seattle, WA. I also do freelance illustration, design, branding and web development.
          </p>
          <p>
          Before joining Rover I worked as a <span className="highlight">Lead UI Designer</span> at <a href="https://www.cogolabs.com/" target="_blank">Cogo Labs</a>, a startup accelerator in Cambridge, MA. I am responsible for a wide variety of tasks and ownership at all stages of the web development pipeline including <span className="highlight">Brainstorming, Brand Development, Logo Design, Wireframing, Prototyping, Web Design, Front End Development, Email Design & Development, A/B Testing and User Testing.</span> Working at a startup accelerator has allowed me to contribute to lots of diverse, fast moving projects in markets such as <span className="highlight">Social Networking, Healthcare, Financial Services, Online Dating, Apartment Rentals,</span> and <span className="highlight">Weather</span> among others. As Lead UI Designer I am also responsible for leading the design team, which involves prioritizing and assigning design tasks, mentoring junior designers and leading the hiring process for new designers.
          </p>
          <p>
          I have also worked as a web designer for Liquid Wireless, a mobile marketing startup owned by Publishers Clearing House. My responsibilities including <span className="highlight">Designing Mobile Advertisements, Landings Pages, Android Apps</span> and <span className="highlight">B2B marketing Resources</span> as well as <span className="highlight">Email Design & Development.</span> I managed one direct report.
          </p>
          <p>
